$(document).ready(function () {
  ...
  document.getElementById("artikel-length").innerText = perPage;
  ...
  function renderBannerArtikelMobile(data) {
  ...
  $("#banner-artikel-mobile").html(renderBannerArtikelMobile(articles));
