                ...
                <div class="col-6 col-md-4 p-1">
                    <a href="#" style="text-decoration: none;color: black;cursor:default">
                        <div class="card position-relative">
                            <div class="card-body">
                                <div id="promo-img" class="d-flex align-items-center justify-content-center visual-promo"
                                    style="border-radius: 10px;height: 13vh;background-color: #d40000;color: white;">
                                    Visual Promo
                                </div>
                                <p class="d-block" style="font-weight: bold;">
                                ...
                                <span class="d-block" style="color: #c5c5c5;">
